...
class login_page:
    def __init__(self, root):
        self.window = root
        self.window.title("Log In Fitness Trainer")
        ...
        label1 = Label(self.frame1, text= "Fitness", font=("times new roman", 40, "bold"),bg="yellow", fg="red").place(x=40,y=300)
        label2 = Label(self.frame1, text= "TrAIner", font=("times new roman", 40, "bold"),bg="yellow", fg="RoyalBlue1").place(x=210,y=300)
        label3 = Label(self.frame1, text= "It's all about Correct posture", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
        ...
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Wellcome to the Fitness trAIner application",parent=self.window)
                    # Clear all the entries
                    self.reset_fields()
                    self.redirect_application()
